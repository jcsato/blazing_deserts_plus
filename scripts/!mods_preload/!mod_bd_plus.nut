::mods_registerMod("blazing_deserts_plus", 0.7, "Blazing Deserts+");
...
::mods_hookExactClass("states/world_state", function(ws) {
	...
	::mods_override(ws, "startNewCampaign", function() {
		...
		local party = World.spawnEntity("scripts/entity/world/party", World.EntityManager.getSettlements()[0].getTile().Coords);

		party.getSprite("body").setBrush("figure_crownling_01");
